...
- **커뮤니티 지표가 0입니다.** star 0 · fork 0 · **외부 기여자의 PR 0건**입니다. 이슈 템플릿·기여 가이드·good first issue·Discussions 를 갖췄고 커뮤니티 프로필 health 는 100% 이지만, **실제로 밖에서 들어온 기여는 아직 없습니다.** 지금까지의 PR 212건은 저희 203건과 **Dependabot 9건**이고 **외부 사람이 연 PR 은 0건**입니다.
